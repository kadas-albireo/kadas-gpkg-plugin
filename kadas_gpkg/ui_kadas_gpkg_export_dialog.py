...
class Ui_KadasGpkgExportDialog(object):
    ...
    def retranslateUi(self, KadasGpkgExportDialog):
        ...
        self.labelNote.setText(_translate("KadasGpkgExportDialog", "<html><head/><body><p><span style=\" font-size:small; font-style:italic;\">Layers with unknown size or larger than 50 MB are deselected by default.</span></p></body></html>"))
